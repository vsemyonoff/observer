...
void RunPerfTest(size_t count = 1000000000)
{
    ...
    std::cout << "**> Boost/Plain            : " << double(b_time) / double(p_time) << std::endl;
    std::cout << "**> Own/Plain              : " << double(o_time) / double(p_time) << std::endl;
    std::cout << "**> Boost/Own              : " << double(b_time) / double(o_time) << std::endl;
    std::cout << "**> Result                 : " << PerfTest::instance().result << std::endl;
}
